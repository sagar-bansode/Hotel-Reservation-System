<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_login.aspx.cs" Inherits="WebApplication1.Hotel.admin_login" %>
...
<tr>
<th  class="llqn" colspan="6" ><h1><b> Admin Login </b></h1>
</th></tr>
<tr>
<td class="wqr wqe">
 <b> User Id:</b>
...
<center>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button1" runat="server" Text="Login" class="style4 a11" Height="54px" OnClick="Button1_Click" Width="141px" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="Label1" runat="server" CssClass="auto-style8" Font-Bold="True" Font-Italic="True" ForeColor="Red"></asp:Label>
    <br />
    </center>
